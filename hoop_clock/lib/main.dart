...
void main() {
  ...
  //  - A clock widget (in this case, [HoopClock])
  //  - A model (provided to you by [ClockModel])
  // For more information, see the flutter_clock_helper package.
  //
  // Your job is to edit [HoopClock], or replace it with your own clock
  // widget. (Look in hoop_clock.dart for more details!)
  runApp(ClockCustomizer((ClockModel model) => HoopClock(model)));
}
